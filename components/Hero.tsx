  ...
  return (
    <section
      ...
      <section
        ...
        <div className="hero-content-container py-16 mt-10 ">
          ...
          <div className="mx-auto my-8 w-fit rounded-full bg-zinc-900 px-4 py-1 text-center font-semibold text-white md:text-xs">
            ✨ Seja um dos 100 primeiros instrumentadores e ganhe prioridade!
          </div>
        </div>
      </section>
    </section>
